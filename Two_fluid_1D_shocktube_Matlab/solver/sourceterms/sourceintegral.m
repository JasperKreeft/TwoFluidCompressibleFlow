...
% bi     = (gamma1*(pi+pi1)-gamma2*(pi+pi2))/(gamma1*(pi+pi1)/alphai+gamma2*(pi+pi2)/(1-alphai));
...
% bR     = (gamma1*(pR+pi1)-gamma2*(pR+pi2))/(gamma1*(pR+pi1)/alphaR+gamma2*(pR+pi2)/(1-alphaR));
...
% bL     = (gamma1*(pL+pi1)-gamma2*(pL+pi2))/(gamma1*(pL+pi1)/alphaL+gamma2*(pL+pi2)/(1-alphaL));
